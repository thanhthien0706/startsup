$(document).ready(function(){
    ...
    console.log($('.box_parameter').outerHeight());
    console.log($('.box_parameter').scrollTop());
    console.log($('.box_parameter').prop ("scrollHeight"));
    if( ($('.box_parameter').outerHeight() + $('.box_parameter').scrollTop() ) >=$('.box_parameter').prop ("scrollHeight")  ){
        console.log("da vao");
    }
